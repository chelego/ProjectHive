...
namespace ProjectHive.AI.Mob
{
    ...
    public class MobAISettings : ScriptableObject
    {
        ...
        // 순찰 지점을 몇 개까지 순회할 지
        [SerializeField, Min(1)] private int patrolPointCount = 8;
        // 점수를 매길 후보를 몇 개까지
        [SerializeField, Min(1)] private int patrolPointCandidateCount = 15;
        // 순찰 지점끼리 최소한의 거리
        [SerializeField, Min(0f)] private float patrolPointSpacing = 10f;
        // 후보 시도 상한
        [SerializeField, Min(1)] private int patrolPointMaxAttempts = 40;
        // 지점이 얼마나 트여있는가?(가시성)를 판단하기 위해 발사하는 방향의 수
        [SerializeField, Min(4)] private int patrolPointOpennessRays = 12;
        ...
        [Header("Search")]
        // Search 상태 이동속도
        [SerializeField, Min(0f)] private float searchSpeed = 8f;
        ...
        public int PatrolPointCandidateCount => patrolPointCandidateCount;
        public float PatrolPointSpacing => patrolPointSpacing;
        public int PatrolPointMaxAttempts => patrolPointMaxAttempts;
        public int PatrolPointOpennessRays => patrolPointOpennessRays;
