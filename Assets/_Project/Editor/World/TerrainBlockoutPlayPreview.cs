...
namespace ProjectHive.EditorTools.World
{
    ...
    internal static class TerrainBlockoutPlayPreview
    {
        ...
        private const string PreviewFlashlightName = "PreviewFlashlight";
        ...
        private static void CreatePreviewPlayer()
        {
            ...
            CreatePreviewFlashlight(view.transform);
            ...
            Debug.Log(
                ...
                "WASD move, Shift sprint, Space jump/parkour, C or Ctrl crouch/slide, " +
                "F flashlight, mouse look.");
        }

        private static void CreatePreviewFlashlight(Transform cameraTransform)
        {
            GameObject flashlightObject = new GameObject(PreviewFlashlightName);
            ...
            flashlight.color = new Color(0.82f, 0.9f, 1f);
            flashlight.intensity = 9f;
            flashlight.range = 32f;
            flashlight.spotAngle = 62f;
            flashlight.innerSpotAngle = 38f;
            flashlight.shadows = LightShadows.Soft;
            flashlight.shadowStrength = 0.85f;
            flashlight.shadowBias = 0.04f;
            flashlight.shadowNormalBias = 0.4f;
            flashlight.shadowNearPlane = 0.1f;
            flashlight.enabled = false;

            flashlightObject.AddComponent<FirstPersonFlashlight>();
        }
